...
namespace TablasDinamicas
{
    class CtrlProductos : Conexion
    {
        ...
        public bool actualizar(Productos datos)
        {
            ...
            bool bandera = false;
            string sql = "UPDATE productos SET codigo='"+datos.Codigo+ "',nombre='" + datos.Nombre + "',descripcion='" + datos.Descripcion + "',precio_publico='" + datos.Precio_publico + "',existencias='" + datos.Existencias + "' WHERE codigo='" + datos.Codigo + "')";
